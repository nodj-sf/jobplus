...
import RestaurantModal from './RestaurantItemModal';
      ...
      <li className="restaurantLI one-third" >
        <div className="nameRating">
          <a
            href={ restaurant.url }
            target="_blank">
            <h5 className="text-of expandFromCenter">{ this.parseAndFormatJobTitle(restaurant.name) }</h5>
          </a>
          {
            (restaurant.photo) ?
              <div
                className="yelpPhoto text-of"
                data-magnify="&#x1f50d">
                <img
        ...
        <div className="yelpDescription card-body">
          <div className="YelpRating_Div">
            ...
            <p className="numRestaurantReviews">{ `${this.props.restaurantListItem.review_count} Reviews` }</p>
          </div>
          ...
          <div>
            <div className="amenityDistanceInMiles">
              {[
                <i
                  className="fa fa-map"
                  key={ `Distance_${restaurantDistance}` } />,
                `\t`,
                <a

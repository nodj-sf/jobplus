...
class SearchBar_Home extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    return (
      <form id="search-form-home" onSubmit={ this.onFormSubmit }>
        <div className="box">
          <div className="container-3">
            <div id="search-inputs-boundary">
              <div className="form-search-inpt">
                <input
                  id="searchJob"
...
export default connect(mapStateToProps, mapDispatchToProps)(SearchBar_Home);
